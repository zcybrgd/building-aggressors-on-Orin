...
//this program is to check the properties of the GPU devices available on the system using the cudagetdeviceproperties function
//command to compile: nvcc props.cu -o props
//command to run: ./props or props.exe if on Windows
int main() {
    int deviceCount;
